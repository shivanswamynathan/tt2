...
class OrchestratorAgent:
    ...
    def handle_button_node(self, state: OrchestratorState) -> Dict[str, Any]:
        ...
        if user_query in ["more_examples", "more examples"]:
            ...
            if relevance == "RELEVANT":
                ...
                response_message = f"I'm not sure how to respond to that. Could you clarify or ask something related to the current topic ({title})?"
                logger.info(f"Irrelevant question detected for {title}: {user_query[:100]}... Responding with nudge to stay on topic.")
    ...
    def handle_qa_node(self, state: OrchestratorState) -> Dict[str, Any]:
        ...
        if relevance == "RELEVANT":
            ...
            combined = f"I'm not sure how to respond to that. Could you clarify or ask something related to the current topic ({current_concept})?"
            logger.info(f"Irrelevant question detected for {current_concept}: {user_query[:100]}... Responding with nudge to stay on topic.")
    ...
    def handle_custom_node(self, state: OrchestratorState) -> Dict[str, Any]:
        ...
        user_query = state["user_message"]
        response = f"I'm not sure how to respond to that. Could you clarify or ask something related to the current topic ({current_concept})?"
        logger.info(f"Irrelevant question detected for {current_concept}: {user_query[:100]}... Responding with nudge to stay on topic.")
