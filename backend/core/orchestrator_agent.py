...
class OrchestratorAgent:
    ...
    async def start_revision_session(self, topic: str, student_id: str, session_id: str) -> Dict[str, Any]:
        ...
        output_state = await self.app.ainvoke(state)
    ...
    async def present_concept_node(self, state: OrchestratorState) -> Dict[str, Any]:
    ...
    async def handle_input_node(self, state: OrchestratorState) -> Dict[str, Any]:
        # Save user turn
        user_turn = {
    ...
    async def detect_intent_node(self, state: OrchestratorState) -> Dict[str, Any]:
        conv_hist = self._format_conversation_history(state)
    ...
    async def handle_ack_node(self, state: OrchestratorState) -> Dict[str, Any]:
    ...
    async def handle_button_node(self, state: OrchestratorState) -> Dict[str, Any]:
    ...
    async def handle_qa_node(self, state: OrchestratorState) -> Dict[str, Any]:
        """Handle Q&A requests"""
        conv_hist = self._format_conversation_history(state)
        current_concept = state.get("current_question_concept", "")
        current_chunk_idx = state.get("current_chunk_index", 0)
    ...
    async def handle_custom_node(self, state: OrchestratorState) -> Dict[str, Any]:
    ...
    async def evaluate_answer_node(self, state: OrchestratorState) -> Dict[str, Any]:
    ...
    async def conclusion_node(self, state: OrchestratorState) -> Dict[str, Any]:
        conv_hist = self._format_conversation_history(state)
        summary = await self.conclusion_agent.summary(
            correct=len(state.get("concepts_learned", [])),
