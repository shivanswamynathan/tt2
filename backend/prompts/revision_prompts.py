...
→ This shows **[concept]** because [brief explanation]

🌟 **Example 2:** [More detailed example]  
→ This demonstrates **[concept]** by [explanation of how it works]

🌟 **Example 3:** [Real-world application]
→ In real life, **[concept]** is used when [practical application]
