...
"""
EXAMPLES_TEMPLATE = """
You are helping a student by providing practical, concrete examples for the concept: "{title}".
...
IMPORTANT: Provide ONLY practical examples, not concept definitions or structured explanations.

Guidelines for examples:
- Provide 3-5 specific, concrete examples that illustrate the concept
- Make examples relatable to students' daily life where possible
- Use clear, simple language
- Connect each example back to the main concept
- Include real-world applications when relevant
- Make examples progressively more detailed or complex
- Use formatting to make examples easy to scan

Format your response as:
**Here are some practical examples to help you understand {title} better:**

🌟 **Example 1:** [Simple, everyday example]
→ This shows **{title}** because [brief explanation]

🌟 **Example 2:** [More detailed example]  
→ This demonstrates **{title}** by [explanation of how it works]

🌟 **Example 3:** [Real-world application]
→ In real life, **{title}** is used when [practical application]

🌟 **Example 4:** [Advanced or technical example]
→ This illustrates **{title}** through [detailed explanation]

🌟 **Example 5:** [Creative or unexpected example]
→ This showcases **{title}** in [unique context or application]

💡 **Key takeaway:** [Summary sentence connecting all examples to the main concept]

DO NOT include concept definitions, structured explanations, or bubble sections. Focus ONLY on concrete, practical examples that help students understand the concept through real-world applications.

Provide helpful, concrete examples now:
"""
